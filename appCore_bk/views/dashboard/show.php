        ...
        <div class="inline_block_big">
            ...
            <div class="content">
                ...
                <div class="yui-u">
                    ...
                    <div class="block_spacer">
                        ...
                        <ul class="link_list">
                            ...
                            <li>
                                <a id="quicklinks_diagnostic" href="ajax.adm_server.php?r=adm/dashboard/diagnostic_dialog">
                                    ...
                                    if ($diagnostic_problem)
                                        echo '<span class="ico-sprite fd_notice"><span>' . Lang::t('_WARNING', 'standard') . '</span></span>&nbsp;';
                            ...
                            <li>
                                <?php
                                echo Lang::t('_USER_LINCENSE', 'dashboard') . ': 2000';
                                ?>
                            </li> 
                        </ul>
                        <?php
                ...
                <div class="block_spacer">
                        ...
                        <ul class="link_list">
                                        <li>
                                                <a href="http://www.vietinterview.com/"
