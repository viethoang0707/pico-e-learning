...
class QuestBank_Selector {
    ...
    function get_filter() {
        ...
        $str = $this->form->getOpenFieldset($this->lang->def('_SEARCH'), 'fieldset_search_quest')
                . $this->form->getDropdown($this->lang->def('_TEST_QUEST_CATEGORY'), 'quest_category', 'quest_category', $this->all_category, Get::req('quest_category', DOTY_INT))
                . $this->form->getDropdown($this->lang->def('_DIFFICULTY'), 'quest_difficult', 'quest_difficult', $this->all_difficult, Get::req('quest_difficult', DOTY_ALPHANUM))
                . $this->form->getDropdown($this->lang->def('_TYPE'), 'quest_type', 'quest_type', $this->all_quest_type_long, Get::req('quest_type', DOTY_INT))
                . $this->form->openButtonSpace('search_button')
                . $this->form->getButton('quest_reset', 'quest_reset', $this->lang->def('_UNDO'), false, ' style="visibility: hidden;" ')
                . $this->form->getButton('quest_search', 'quest_search', $this->lang->def('_SEARCH'))
