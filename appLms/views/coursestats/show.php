...
<div class="std_block">
        ...
        <div>
            <div class="simple_search_box" id="usermanagement_simple_filter_options" style="display: block;">
                ...
                . Form::getInputDropdown(
                        'dropdown', 'filter_selection', 'filter_selection', array(
    ...
    <div>
        <a class="ico-wt-sprite subs_csv" href="index.php?modname=stats&op=export_course&idItem=<?php echo $_SESSION['idCourse'] ?>"><span>Báo cáo khóa học</span></a>
    </div>
<?php
$columns = array(
...
foreach ($lo_list as $lo) {
    ...
    $link = '';
    switch ($lo->type) {
        case "poll": $link = '<a title="" href="index.php?r=coursestats/show_object&id_lo=' . (int) $lo->id . '">' . $lo->title . '</a>';
            break;
