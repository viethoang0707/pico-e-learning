...
echo	getTitleArea($title)
		...
		.Form::getFilefield( Lang::t('_IMPORT_FILE', 'subscription'), 'file_import', 'file_import')
		.Form::getCheckbox( Lang::t('_IMPORT_HEADER', 'subscription'), 'import_first_row_header', 'import_first_row_header', 'true', false )
