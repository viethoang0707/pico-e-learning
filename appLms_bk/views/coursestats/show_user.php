...
<div class="std_block">
    ...
    ?>
    <div>
        <a class="ico-wt-sprite subs_csv" href="index.php?modname=stats&op=export_user_of_course&id_user=<?php echo $_GET['id_user'] ?>"><span><?php echo Lang::t('_EXPORT_CSV', 'standard') ?></span></a>
    </div>
    <?php
    echo getBackUi($base_url, Lang::t('_BACK', 'standard'));
    ?>
