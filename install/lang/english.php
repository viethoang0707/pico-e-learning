...
define("_INSTALLER_TITLE", "e-Training - Installation");
...
e-Training is a free open source Learning Management System developed by Thanh Cong A Chau JSC, based on the open source project e-Training, already used by hundreds of companies and universities all over the world.
...
define("_SQL_STRICT_MODE_WARN", "You have MySQL <a href=\"http://dev.mysql.com/doc/en/server-sql-mode.html\" target=\"_blank\">strict mode</a> enabled; e-Training doesn't support it, so please turn it off");
...
// -----------------------------------------
define("_UPGRADER_TITLE", "e-Training - Upgrade");
...
define("_VERSION","e-Training version");
define("_START","Start");
define("_END","Final");
...
define("_UPGRADE_NOT_NEEDED","You already have the latest version of e-Training, no need to upgrade.");
