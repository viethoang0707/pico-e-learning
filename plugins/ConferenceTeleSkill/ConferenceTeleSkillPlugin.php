...
class ConferenceTeleskillPlugin extends FormaPluginConference implements FormaPluginConferenceInterface {
// class ConferenceTeleskillPlugin extends FormaPlugin {
	...
	public function activate() {
		$res = sql_query(
			"insert into core_setting
			 ...
			 values 
				 ('code_teleskill','code','string',255,'teleskill',6,3,1,0,'')
				,('org_name_teleskill','sd','string',255,'teleskill',6,4,1,0,'')
				...
				,('url_videoconference_teleskill','a','string',255,'teleskill',6,2,1,0,'')
			"
		);
	...
	public function deactivate() {
		$res = sql_query(
			"delete from core_setting where param_name in (
				 'code_teleskill'
				,'org_name_teleskill'
				,'teleskill_max_participant'
				,'teleskill_max_room'
				,'url_checkin_teleskill'
				,'url_videoconference_teleskill'	
			)			
			"
		);
	 ...
	 */
	function insertRoom($idConference,$title, $start_date, $end_date, $capacity='') {
	 ...
	 */
	function deleteRoom($idConference) {
