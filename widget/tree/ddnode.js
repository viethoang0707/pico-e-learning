...
YAHOO.extend(YAHOO.util.DDNode, YAHOO.util.DDProxy, {
	...
	onDragEnter: function(e, id) {
		...
		var o = this.stree._dragEnterEvent;
		o.eventFunction.call(o.eventScope, dest_node, {oDD: this});
	},
	...
	onDragOut: function(e, id) {
		...
		var left_node = this.stree._tree.getNodeByElement(YAHOO.util.Dom.get(id));
		var o = this.stree._dragOutEvent;
		o.eventFunction.call(o.eventScope, left_node, {oDD: this});
	},
...
*/
	...
	onDrag: function(e) {
		var o = this.stree._dragEvent;
		o.eventFunction.call(o.eventScope, { //pass source element of the dragdrop action, the target element of the event, the proxy element
			source: this.getEl(),
			target: e.target,
	...
	onDragOver: function(e, id) {
		...
		var srcNode = this.stree.getNodeByElement(srcEl);
		var destNode = this.stree.getNodeByElement(destEl);

		var o = this.stree._dragOverEvent;
		o.eventFunction.call(o.eventScope, srcNode, destNode, {oDD: this});
		*/
	},
